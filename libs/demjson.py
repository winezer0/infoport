...
class jsonlint(object):
    """This class contains most of the logic for the "jsonlint" check_live_options.
...
GENERAL OPTIONS:
 ...
 -value | --verbose    Show details of lint checking
...
MORE INFORMATION:
    ...
    Use '%(program_name)s --version [-value]' to see versioning information.
